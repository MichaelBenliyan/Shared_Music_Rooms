...
class UpdateRoom(APIView):
    ...
    #patch is another word for update 
    #post is for creating something new on the server
    def patch(self, request, format=None):
        ...
        if serializer.is_valid(): 
            ...
            if room.host != user_id: 
                return Response({"msg": "You Don't Own This Room!"}, status=status.HTTP_403_FORBIDDEN)
